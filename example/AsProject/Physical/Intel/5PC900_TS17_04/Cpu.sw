...
<SwConfiguration xmlns="http://br-automation.co.at/AS/SwConfiguration" CpuAddress="SL1">
  ...
  <Libraries>
    ...
    <LibraryObject Name="smramp" Source="Libraries.Loupe.smramp.lby" Memory="UserROM" Language="IEC" Debugging="true" />
    <LibraryObject Name="spdestlib" Source="Libraries.Loupe.spdestlib.lby" Memory="UserROM" Language="Binary" Debugging="true" />
  </Libraries>
</SwConfiguration>
